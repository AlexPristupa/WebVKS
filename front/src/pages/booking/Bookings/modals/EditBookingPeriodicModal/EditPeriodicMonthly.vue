    ...
    <el-radio-group :value="tab">
      ...
      >
        ...
        <div
          ...
          :class="{ 'settings-block--one-setting': item.id === 2 }"
...
import {
  list,
  weekdaysList,
} from '@/pages/booking/Bookings/modals/EditBookingPeriodicModal/config/editPeriodicWeekly.const.ts'
import {
  datePickerTypes,
  timeFormats,
...
} from '@/pages/booking/Bookings/modals/EditBookingPeriodicModal/config/editPeriodicMonthly.interface'
import { DateTime } from '@/modules/DateTime/DateTime'
import {
  monthStringFormators,
  weekdays,
} from '@/pages/booking/Bookings/modals/EditBookingPeriodicModal/config/editPeriodicMonthly.const'
