...
import { bookingListColumns } from '@/pages/booking/BookingsRestricted/config/bookingListPanel.const'
import {
  IComputedBookingListPanel,
  IDataBookingListPanel,
  IMethodsBookingListPanel,
  IPropsBookingListPanel,
} from '@/pages/booking/BookingsRestricted/config/bookingListPanel.interface'
