...
{
    public class ServersGroupsRepository : TableBasedEntityRepositoryBase<ServersGroups>, IServersGroupsRepository
    {
        public ServersGroupsRepository(DataContext context, IColumnMappingConfiguration mappings) : base(context, mappings)
        {
        }
