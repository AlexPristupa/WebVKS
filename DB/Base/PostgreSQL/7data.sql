...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (1, 'MMS', 'MMS', NULL, 'Система управления конференциями')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (10, 'MMS_BOOKING', 'MMS_BOOKING', 1, 'Бронирование')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (11, 'MMS_SETTINGS', 'MMS_SETTINGS', 1, 'Настройки')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (13, 'MMS_REPORTS', 'MMS_REPORTS', 1, 'Отчеты')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (14, 'MMS_USERS', 'MMS_USERS', 1, 'Пользователи')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (100, 'MMS_BOOKING_BOOKING', 'MMS_BOOKING_BOOKING', 10, 'Бронирования')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (101, 'MMS_BOOKING_ROOMS', 'MMS_BOOKING_ROOMS', 10, 'Комнаты')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (102, 'MMS_BOOKING_RECORDS', 'MMS_BOOKING_RECORDS', 10, 'Записи')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (103, 'MMS_BOOKING_BOOKING_PERSON', 'MMS_BOOKING_BOOKING_PERSON', 10, 'Бронирования')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (200, 'MMS_SETTINGS_USERPROFILES', 'MMS_SETTINGS_USERPROFILES', 11, 'Профили пользователей')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (201, 'MMS_SETTINGS_GROUPSOFROOMS', 'MMS_SETTINGS_GROUPSOFROOMS', 11, 'Группы комнат')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (202, 'MMS_SETTINGS_RECORDSTORES', 'MMS_SETTINGS_RECORDSTORES', 11, 'Хранилища записей')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (300, 'MMS_CMS_SERVERS', 'MMS_CMS_SERVERS', 12, 'Сервера')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (301, 'MMS_CMS_GROUPS', 'MMS_CMS_GROUPS', 12, 'Группы')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (400, 'MMS_REPORTS_REPORTS', 'MMS_REPORTS_REPORTS', 13, 'Отчеты')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (401, 'MMS_REPORTS_DISTRIBUTIONOFREPORTS', 'MMS_REPORTS_DISTRIBUTIONOFREPORTS', 13, 'Рассылка отчетов')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (500, 'MMS_USERS_USERS', 'MMS_USERS_USERS', 14, 'Пользователи')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles (Id, Name, NormalizedName, ParentId, ViewName) values (501, 'MMS_USERS_ROLES', 'MMS_USERS_ROLES', 14, 'Роли')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetRoles(Id, Name, NormalizedName, ParentId, ViewName) values (502, 'MMS_USERS_LOGS', 'MMS_USERS_LOGS', 14, 'Журнал')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (1, 'Система управления конференциями', NULL, 1)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (10, 'Бронирование', 1, 10)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (11, 'Настройки', 1, 11)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (13, 'Отчеты', 1, 13)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (14, 'Пользователи', 1, 14)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (100, 'Бронирования', 10, 100)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (101, 'Комнаты', 10, 101)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (102, 'Записи', 10, 102)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (103, 'Бронирования', 10, 103)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (200, 'Профили пользователей', 11, 200)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (201, 'Группы комнат', 11, 201)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (202, 'Хранилища записей', 11, 202)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (300, 'Сервера', 12, 300)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (301, 'Группы', 12, 301)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (400, 'Отчеты', 13, 400)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (401, 'Рассылка отчетов', 13, 401)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (500, 'Пользователи', 14, 500)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (501, 'Роли', 14, 501)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.AspNetTreePages(idr, ViewName, ParentId, RoleId) values (502, 'Журнал', 14, 502)
;
END IF;END $do$;
COMMIT;
...
insert into dbo.rlsSettingList (Id, Name, PrivateName, Visible) values (1, 'Список комнат пользователя','SPACES_LIST',true)
;END IF;END $do$;
COMMIT;
...
insert into dbo.rlsSettingList (Id, Name, PrivateName, Visible) values (2, 'Список записей пользователя','RECORDING_LIST',true)
;END IF;END $do$;
COMMIT;
...
-- пользователь имеет доступ только к закладкам для назначения прав
-- сам себе права изменить не может
...
VALUES
  ...
  , N'904a1cf0-813f-4304-a6a2-ff1c94039733', FALSE, N'admin', 'admin','Администратор системы');
...
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt)  values('>','больше',0)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '<')
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('<','меньше',0)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '>=')
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('>=','больше или равно',0)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '<=')
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('<=','меньше или равно',0)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('=','равно',3)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '!=' and ColumnTypeFilt=3) 
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('!=','не равно',3)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '~') 
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('~','содержит точно',1)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '!~') 
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('!~','не содержит точно',1)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('~*','содержит слева',1)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '*~' and ColumnTypeFilt=1) 
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('*~','содержит справа',1)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '*~*') 
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('*~*','содержит',1)
;
END IF;END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where Operand = '!*~*') 
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('!*~*','не содержит',1)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList (OperationName,Operand,ColumnTypeFilt) values ('равно','=',8)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList (OperationName,Operand,ColumnTypeFilt) values ('не равно','!=',8)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList (OperationName,Operand,ColumnTypeFilt) values ('содержит слева','~*',8)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList (OperationName,Operand,ColumnTypeFilt) values ('содержит справа','*~',8)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('null','не указано',1)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList(Operand, OperationName,ColumnTypeFilt) values('null','не указано',2)
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterOperationsList (OperationName, Operand, ColumnTypeFilt) values ('не содержит справа','!*~',8)
;
END IF;
END $do$;
COMMIT;
...
DO $do$ BEGIN
if not exists (select 1 from dbo.FilterOperationsList where ColumnTypeFilt = 8 and Operand='!~*')
then insert into dbo.FilterOperationsList (OperationName, Operand, ColumnTypeFilt) values ('не содержит слева','!~*',8)
;
END IF;
END $do$;
COMMIT;
...
values(1, 'выбор', 'select vc.id, vc.value,   
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(2, 'временной', 'select ROW_NUMBER() OVER(ORDER BY fv.FValue ASC) as id, fv.FValue as value, fol.Operand as operand, 
CASE 
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(3, 'числовой', 'select ROW_NUMBER() OVER(ORDER BY fv.FValue ASC) as id, fv.FValue as value, fol.Operand as operand, 
CASE 
WHEN (fv.FValue is null or fv.FValue = '''') 
THEN 1 
ELSE 0
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(4, 'строковый', 'select ROW_NUMBER() OVER (ORDER BY fv.FValue ASC) as id, fv.FValue as value, fol.Operand as operand, 
CASE 
WHEN (fv.FValue is null or fv.FValue = '''') 
THEN 1 
ELSE 0 
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(5, 'время', 'select ROW_NUMBER() OVER(ORDER BY fv.FValue ASC) as id, fv.FValue as value, fol.Operand as operand,   
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(6, 'структура','select ROW_NUMBER() OVER(ORDER BY fv.FValue ASC) as id,fv.FValue as value,fol.Operand as operand,CASE WHEN (fv.FValue is null or fv.FValue = '''') THEN 1 ELSE 0 END as isEmptyDate from dbo.FiltersList fl inner join dbo.FilterValue fv on fv.FilterId = fl.idr inner join dbo.FilterColumnsList fcl on fcl.idr = fv.ColumnId inner join dbo.FilterOperationsList fol on fol.idr = fv.OperationId where fl.idr = {0} and fcl.ColumnName = ''{1}'' and NOT fv.OperationId IS NULL')
;
END IF;END $do$;
COMMIT;
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(7, 'выбор fts', 'select vc.id, vc.value,   
(case when FValue IS NULL then '''' else ''check'' end) as state 
from (select ROW_NUMBER() OVER(ORDER BY {0} ASC) as id, {0} as value  from {1}  group by {0}) vc  
left join (select fv.FValue from dbo.FiltersList fl  
inner join dbo.FilterValue fv on fv.FilterId = fl.idr  
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(8, 'строковый fts', 'select ROW_NUMBER() OVER (ORDER BY fv.FValue ASC) as id, fv.FValue as value, fol.Operand, 
CASE WHEN (fv.FValue is null or fv.FValue = '''') THEN 1 ELSE 0 END as isEmptyDate 
from dbo.FiltersList fl 
inner join dbo.FilterValue fv on fv.FilterId = fl.idr 
inner join dbo.FilterColumnsList fcl on fcl.idr = fv.ColumnId 
...
then insert into dbo.FilterForColumnTypeList(TypeId, TypeName, DataQuery)
values(9, 'структура fts', 'select ROW_NUMBER() OVER(ORDER BY fv.FValue ASC) as id,fv.FValue as value,fol.Operand as operand,CASE WHEN (fv.FValue is null or fv.FValue = '''') THEN 1 ELSE 0 END as isEmptyDate 
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'name') then 
  ...
  VALUES('Vks_Booking','name', 'Наименование', 'name', 1, 170, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'description') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','description', 'Описание', 'description', 2, 145, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'owner') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','owner', 'Владелец', 'owner', 3, 164, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'spaceName') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','spaceName', 'Комната', 'spacename', 4, 145, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'schedule') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','schedule', 'Периодическая', 'schedule', 6, 151, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'type') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','type', 'Тип конференции', 'type', 7, 162, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'currentStatus') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','currentStatus', 'Текущий статус', 'currentStatus', 8, 155, NULL, NULL, NULL, NULL, false, false, false, '', false, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'nextRun') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','nextRun', 'Следующий запуск', 'nextrun', 9, 178, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','actions', 'Действия', 'actions', 10, 150, NULL, NULL, NULL, 252, true, true, true, 'actionButton', false, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Booking' and ColumnName = 'counter') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Booking','counter', 'Счетчик', 'counter', 12, 131, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Spaces' and ColumnName = 'ServersGroupsName') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Spaces','ServersGroupsName', 'Группа серверов', 'ServersGroupsName', 1, 210, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Spaces' and ColumnName = 'name') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Spaces','name', 'Наименование', 'name', 3, 266, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Spaces' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Spaces','actions', 'Действия', 'actions', 4, 90, NULL, NULL, NULL, NULL, true, false, false, 'actionButton', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Recordings' and ColumnName = 'name') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Recordings','name', 'Наименование', 'name', 1, 183, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Recordings' and ColumnName = 'owner') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Recordings','owner', 'Владелец', 'owner', 3, 154, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Recordings' and ColumnName = 'dateStart') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Recordings','dateStart', 'Дата начала', 'dateStart', 4, 165, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Recordings' and ColumnName = 'dateEnd') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Recordings','dateEnd', 'Дата завершения', 'dateEnd', 5, 174, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Recordings' and ColumnName = 'duration') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Recordings','duration', 'Длительность', 'duration', 6, 142, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Recordings' and ColumnName = 'serversGroupsName') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Recordings','serversGroupsName', 'Группа серверов', 'serversGroupsName', 7, 200, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_Recordings' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_Recordings','actions', 'Действия', 'actions', 8, 110, NULL, NULL, NULL, NULL, true, true, true, 'actionButton', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_VksUserProfiles' and ColumnName = 'name') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_VksUserProfiles','name', 'Наименование', 'name', 1, 153, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_VksUserProfiles' and ColumnName = 'description') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_VksUserProfiles','description', 'Описание', 'description', 2, 129, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_VksUserProfiles' and ColumnName = 'serversGroupsName') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_VksUserProfiles','serversGroupsName', 'Группа серверов', 'serversGroupsName', 3, 166, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_VksUserProfiles' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_VksUserProfiles','actions', 'Действия', 'actions', 4, 80, NULL, NULL, NULL, NULL, true, false, false, 'actionButton', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_VksServers' and ColumnName = 'name') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_VksServers','name', 'Наименование', 'name', 1, 180, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_VksServers' and ColumnName = 'basicPath') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_VksServers','basicPath', 'Базовый путь', 'basicPath', 2, 149, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_VksServers' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_VksServers','actions', 'Действия', 'actions', 3, 80, NULL, NULL, NULL, NULL, true, false, false, 'actionButton', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_ServersGroup' and ColumnName = 'name') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_ServersGroup','name', 'Наименование', 'name', 1, 161, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_ServersGroup' and ColumnName = 'description') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_ServersGroup','description', 'Описание', 'description', 2, 134, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_ServersGroup' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_ServersGroup','actions', 'Действия', 'actions', 3, 80, NULL, NULL, NULL, NULL, true, false, false, 'actionButton', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_SpaceGroups' and ColumnName = 'name') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_SpaceGroups','name', 'Наименование', 'name', 1, 161, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_SpaceGroups' and ColumnName = 'description') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_SpaceGroups','description', 'Описание', 'description', 2, 134, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_SpaceGroups' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_SpaceGroups','actions', 'Действия', 'actions', 3, 80, NULL, NULL, NULL, NULL, true, false, false, 'actionButton', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_BookingDialog' and ColumnName = 'name') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_BookingDialog','name', 'Наименование', 'name', 1, 161, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_BookingDialog' and ColumnName = 'description') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_BookingDialog','description', 'Описание', 'description', 2, 147, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_BookingDialog' and ColumnName = 'currentStatus') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_BookingDialog','currentStatus', 'Текущий статус', 'currentStatus', 3, 124, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_BookingDialog' and ColumnName = 'nextRun') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_BookingDialog','nextRun', 'Следующий запуск', 'nextRun', 4, 181, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_SpaceUserRightsDialog' and ColumnName = 'vksUser') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_SpaceUserRightsDialog','vksUser', 'Участник', 'vksUser', 1, 161, NULL, NULL, NULL, NULL, true, false, false, '', false, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_SpaceUserRightsDialog' and ColumnName = 'callLegProfileGuid') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_SpaceUserRightsDialog','callLegProfileGuid', 'Профайл настроек вызова', 'callLegProfileGuid', 2, 180, NULL, NULL, NULL, NULL, true, false, false, '', false, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_SpaceUserRightsDialog' and ColumnName = 'rights') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_SpaceUserRightsDialog','rights', 'Права', 'rights', 3, 720, NULL, NULL, NULL, NULL, true, false, false, '', false, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_SpaceUserRightsDialog' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_SpaceUserRightsDialog','actions', 'Действия', 'actions', 4, 80, NULL, NULL, NULL, NULL, true, false, false, 'actionButton', false, false);
END IF;END $do$;
COMMIT;
--TableName = Vks_RecordingVksUsersDialog
BEGIN;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_RecordingVksUsersDialog' and ColumnName = 'user') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_RecordingVksUsersDialog','user', 'Пользователь', 'user', 1, 440, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_RecordingVksUsersDialog' and ColumnName = 'isPlay') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_RecordingVksUsersDialog','isPlay', 'Просмотр', 'isPlay', 2, 100, NULL, NULL, NULL, NULL, false, false, false, '', false, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_RecordingVksUsersDialog' and ColumnName = 'isDownload') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_RecordingVksUsersDialog','isDownload', 'Загрузка', 'isDownload', 3, 100, NULL, NULL, NULL, NULL, false, false, false, '', false, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_RecordingVksUsersDialog' and ColumnName = 'dateRecord') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_RecordingVksUsersDialog','dateRecord', 'Дата выдачи прав', 'dateRecord', 4, 194, NULL, NULL, NULL, NULL, false, false, false, '', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.TableColumnSettings where TableName = 'Vks_RecordingVksUsersDialog' and ColumnName = 'actions') then 
  INSERT INTO dbo.TableColumnSettings (TableName, ColumnName, Title, Value, "order", MinWidth, Wrap, Template, ClassName, RoleId, NoSortable, NoResizable, ActionButton, CellRenderer, CellsWithoutHint, VisibleCheckBox) 
  VALUES('Vks_RecordingVksUsersDialog','actions', 'Действия', 'actions', 5, 80, NULL, NULL, NULL, NULL, true, false, false, 'actionButton', true, false);
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.LogsType where PrivateName = 'USERPROFILES') then 
  INSERT INTO dbo.LogsType (name, PrivateName) 
  VALUES('Профили пользователей', 'USERPROFILES');
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.LogsType where PrivateName = 'GROUPSOFROOMS') then 
  INSERT INTO dbo.LogsType (name, PrivateName) 
  VALUES('Группы комнат', 'GROUPSOFROOMS');
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.LogsType where PrivateName = 'RECORDSTORES') then 
  INSERT INTO dbo.LogsType (name, PrivateName) 
  VALUES('Хранилища записей', 'RECORDSTORES');
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.LogsType where PrivateName = 'DISTRIBUTIONOFREPORTS') then 
  INSERT INTO dbo.LogsType (name, PrivateName) 
  VALUES('Рассылка отчетов', 'DISTRIBUTIONOFREPORTS');
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.pinpolitics where privatename = 'DONOTCHANGE') then 
  ...
  VALUES(1, 'Не менять', 'DONOTCHANGE');
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.pinpolitics where privatename = 'ENDOFSERIES') then 
  INSERT INTO dbo.pinpolitics (idr, name, privatename) 
  VALUES(2, 'По завершению серии', 'ENDOFSERIES');
END IF;END $do$;
COMMIT;
...
if not exists(select 1 from dbo.pinpolitics where privatename = 'SCHEDULED') then 
  INSERT INTO dbo.pinpolitics (idr, name, privatename) 
  VALUES(3, 'По расписанию', 'SCHEDULED');
END IF;END $do$;
COMMIT;
...
insert into dbo.ntfSubscription (TemplateId, Name, IsActive)
  select idr, 'Бронирование комнаты', true from dbo.ntfNotifyTemplate where PrivateName = 'BookingChange'
;END IF;END $do$;
COMMIT;
...
insert into dbo.ntfSubscription (TemplateId, Name, IsActive)
  select idr, 'Права на запись ВКС', true from dbo.ntfNotifyTemplate where PrivateName = 'RecordingVksUsersChange'
;END IF;END $do$;
COMMIT;
...
insert into dbo.ntfSubscription (TemplateId, Name, IsActive)
  select idr, 'Добавление\удаление записи ВКС', true from dbo.ntfNotifyTemplate where PrivateName = 'RecordingAddDelete'
;END IF;END $do$;
COMMIT;
...
insert into dbo.ntfSubscription (TemplateId, Name, IsActive)
select idr, 'Нотификация о предстоящем удалении записи ВКС', true from dbo.ntfNotifyTemplate where PrivateName = 'RecordingNotification'
;END IF;END $do$;
COMMIT;
...
insert into dbo.ntfSubscription (TemplateId, Name, IsActive)
select idr, 'Нотификация о предстоящей смене ПИН-кода', true from dbo.ntfNotifyTemplate where PrivateName = 'BookingChangePincodeNotification'
;END IF;END $do$;
COMMIT;
...
insert into dbo.ntfSubscription (TemplateId, Name, IsActive)
select idr, 'Нотификация о завершенной встрече', true from dbo.ntfNotifyTemplate where PrivateName = 'ConferenceEnded'
;END IF;END $do$;
COMMIT;
